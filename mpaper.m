...
% It is used to build the data matrix P, saved in -mat format.
...
% In this assignment this function is used only to generate, from a grid
...
% This file has been adapted from the reference given i the following.
